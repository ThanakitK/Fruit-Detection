...
class LoadVino(loadVino) :
    ...
    def Process_output(self,input_image: np.ndarray, img_width, img_height):
        return self.process_output(input_image = input_image, img_width = img_width, img_height = img_height)
